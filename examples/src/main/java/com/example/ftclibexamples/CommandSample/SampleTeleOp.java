...
public class SampleTeleOp extends CommandOpMode {
  ...
  public void initialize() {
    ...
    m_driveCommand =
        new DefaultDrive(m_drive, () -> m_driverOp.getLeftY(), () -> m_driverOp.getLeftX());
    ...
    m_grabButton = (new GamepadButton(m_driverOp, GamepadKeys.Button.A)).whenPressed(m_grabCommand);
    m_releaseButton =
        (new GamepadButton(m_driverOp, GamepadKeys.Button.B)).whenPressed(m_releaseCommand);
