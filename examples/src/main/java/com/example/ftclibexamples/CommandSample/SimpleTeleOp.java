...
public class SimpleTeleOp extends CommandOpMode {
    ...
    public void initialize() {
        ...
        toolOp.getGamepadButton(GamepadKeys.Button.A).whenPressed(new InstantCommand(gripper::grab, gripper));
        toolOp.getGamepadButton(GamepadKeys.Button.B).whenPressed(new InstantCommand(gripper::release, gripper));
