 ...
 * ========================================================= */
// Imported changes from https://github.com/jonmiles/bootstrap-treeview/pull/175
!function (a, b, c, d) {
    "use strict";
    var e = "treeview", f = {};
    f.settings = {
    ...
    g.prototype.init = function (b) {
        ...
        this.$element.trigger('rendered', $.extend(true, {}, this.tree));
