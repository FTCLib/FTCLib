...
/**
 * An end waypoint is an InterruptWaypoint used to represent the end of a path. Every path must end
 * with one of these. This waypoint's action cannot be changed.
 *
