...
/**
 * Allows multiple {@link Motor} objects to be linked together as a single group. Multiple motors
 * will act together.
 *
 * @author Jackson
 */
public class MotorGroup extends Motor {
  ...
  /**
   * Set the motor group to the inverted direction or forward direction. This directly affects the
   * speed rather than the direction.
   *
