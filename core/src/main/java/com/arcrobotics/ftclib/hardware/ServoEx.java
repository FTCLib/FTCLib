...
public interface ServoEx extends HardwareDevice {
   ...
   *
   * @param min The minimum value. Setting the servo position to 0 will bring it to this specified
   *     minimum.
   * @param max The maximum value. Setting the servo position to 1 will bring it to this specified
   *     maximum.
   */
   ...
   *
   * <p>By default, the inversion is false.
   *
