...
public class ProfiledPIDCommand extends CommandBase {
  ...
  public ProfiledPIDCommand(
      @NonNull ProfiledPIDController controller,
      @NonNull DoubleSupplier measurementSource,
      @NonNull Supplier<State> goalSource,
      @NonNull BiConsumer<Double, State> useOutput,
  ...
  public ProfiledPIDCommand(
      @NonNull ProfiledPIDController controller,
      @NonNull DoubleSupplier measurementSource,
      @NonNull DoubleSupplier goalSource,
      @NonNull BiConsumer<Double, State> useOutput,
      Subsystem... requirements) {
