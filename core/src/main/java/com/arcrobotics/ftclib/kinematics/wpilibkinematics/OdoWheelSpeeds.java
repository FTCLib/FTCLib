...
public class OdoWheelSpeeds {
   ...
   */
  public OdoWheelSpeeds(
      double leftMetersPerSecond, double rightMetersPerSecond, double centerMetersPerSecond) {
  ...
  public void normalize(double attainableMaxSpeedMetersPerSecond) {
    ...
    if (realMaxSpeed > attainableMaxSpeedMetersPerSecond) {
      ...
      centerMetersPerSecond =
          centerMetersPerSecond / realMaxSpeed * attainableMaxSpeedMetersPerSecond;
    }
  }
  ...
  public String toString() {
    return String.format(
        "OdoWheelSpeeds(Left: %.2f m/s, Right: %.2f m/s, Strafe: %.sf m/s)",
